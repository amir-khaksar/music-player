            ...
            <div className="relative z-10 w-full max-w-sm">
                ...
                <div className="bg-white/4 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_8px_40px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="flex items-center justify-between px-2">
                        ...
                        <button
                            onClick={handlePlay}
                            className="w-14 h-14 rounded-2xl text-white bg-emerald-500/90 hover:bg-emerald-500 active:scale-95 border border-emerald-400/40 flex items-center justify-center transition-all duration-200 shadow-[0_4px_20px_rgba(16,185,129,0.35)]"
                        >
                    ...
                    {/* ← Progress bar آپدیت شد */}
                    <div className="mt-6">
                        <div
                            className="w-full h-1 bg-white/8 rounded-full overflow-hidden cursor-pointer"
                            onClick={(e) => {
                                const rect =
